...
const AddNav = async () => {
    const html = await fetch("src/components/_navbar.html").then((data) => data.text());
    const contentNav = html.slice(html.indexOf("<div class='mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16 xl:px-28'>"))
